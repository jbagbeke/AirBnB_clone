...
class TestUser(unittest.TestCase):
    ...
    def test_city_id_attribute(self):
        """This function tests the that the Place 
        class has the city_id attribute"""
    ...
    def test_description_attribute(self):
        """This function tests the that the Place 
        class has the description attribute"""
    ...
    def test_number_rooms_attribute(self):
        """This function tests the that the Place 
        class has the number_rooms attribute"""
    ...
    def test_number_bathrooms_attribute(self):
        """This function tests the that the Place 
        class has the number_bathrooms attribute"""
    ...
    def test_max_guest_attribute(self):
        """This function tests the that the Place 
        class has the max_guest attribute"""
    ...
    def test_price_by_night_attribute(self):
        """This function tests the that the Place 
        class has the price_by_night attribute"""
    ...
    def test_latitude_attribute(self):
        """This function tests the that the Place 
        class has the latitude attribute"""
    ...
    def test_longitude_attribute(self):
        """This function tests the that the Place 
        class has the longitude attribute"""
    ...
    def test_amenity_ids_attribute(self):
        """This function tests the that the Place 
        class has the amenity_ids attribute"""
